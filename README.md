...
1. Load a sample resume or upload a synthetic resume/PDF
2. Select a target role
3. Show AI or fallback extraction method
4. Walk through match score and missing skills
5. Show role classifier output
6. Show skill impact simulator and demand heatmap
7. Show roadmap and explain fallback behavior
